...
class Top:
    ...
    def __init__(self, top_slate='sauder_slate.mp4', title=None, course=None, section=None, instructor=None):
        """TODO
        ...
        # Uncomment to see top properties whiel debugging
        # self._print_properties()

    def get_video(self):
        """ TODO
        Returns 6 second top as mp4
        """

        slate = VideoFileClip(f'input/top_slates/{self.top_slate}')

        text_clip_mask = VideoClip(lambda t: self._make_frame(t)[
            :, :, 3] / 255.0, duration=slate.duration, ismask=True)
        text_clip = VideoClip(lambda t: self._make_frame(t)[
        ...
        final_clip = final_clip.fx(fadeout, duration=1.5,
                                   final_color=[255, 255, 255])
