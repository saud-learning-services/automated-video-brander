...
def requires_more_edits(video):
    ...
    '''
    needs_edits = str(
        video['Do you require more editing than just branding?  (If yes, you will be asked for the timecodes of the edits in the next step. Requests for the automated branding of videos will be completed in 24 hours, content edits may require extra processing time.)'])
...
def translate_video_properties(video):
    ...
    '''
    wm_location = str(
        video['Location of watermark? This watermark will be superimposed for the duration of the video in the location chosen. Required.)'])
    watermark = str(video[
    ...
    section_number = str(
        video['Section Number (Course code is required if you enter this section number)'])
    title = str(video[
