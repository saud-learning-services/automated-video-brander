...
def hasValue(cell):
    ...
    # List of Falsy values in Python: https://stackoverflow.com/questions/39983695/what-is-truthy-and-falsy-how-is-it-different-from-true-and-false
    if (not cell):
        return False
...
for index, row in specs.iterrows():
    ...
    wm_position = row['WatermarkPosition']
    ...
    top = VideoFileClip(f'input/top/{top}')
    ...
    if (hasValue(body)):
        ...
        if (hasValue(watermark)):
            ...
            body = body_wm.fx(vfx.fadeout, duration=1, final_color=[255,255,255])
        else:
            body = raw_body.fx(vfx.fadeout, duration=1, final_color=[255,255,255])
